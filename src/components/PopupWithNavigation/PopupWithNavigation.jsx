        ...
        <div className={`popup ${props.isOpen}`}>
            ...
            <nav className="popup__nav">
                <div className="popup__container">
                    <NavLink exact to="/" className="popup__link">Главная</NavLink>
                    <NavLink exact to="/movies" className="popup__link">Фильмы</NavLink>
                    <NavLink to="/saved-movies" className="popup__link">Сохранённые фильмы</NavLink>
                </div>
                <NavLink to="/profile" className="popup__link-account">
